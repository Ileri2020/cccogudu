...
const Blog = () => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      console.log("Tab from URL params:", tab);
  ...
  return (
    <Tabs defaultValue={initialTab} value={initialTab} onValueChange={(value) => setInitialTab(value)} className="flex flex-col lg:flex-row gap-[60px] mt-5">
